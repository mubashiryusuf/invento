# Inventory Management System — Project Guide (CLAUDE.md)

> This file tells Claude (and its subagents) how to work on this project.
...
Claude has five subagents defined in `claude-agents/`. (When you copy this
project into a Claude Code workspace, rename the folder to `.claude/agents/`
so Claude Code auto-loads them.) Use them like this:
